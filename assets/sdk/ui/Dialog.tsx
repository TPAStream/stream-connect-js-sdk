...
export const Dialog = ({
  ...
  // backgrounds and white text becomes invisible. Add `tpa-sdk-root` to
  // every portaled element so the theme propagates.
  return (
    <HDialog
      open={open}
      onClose={onClose}
    ...
    >
      ...
      <div className="tpa-sdk-root tpa-fixed tpa-inset-0 tpa-flex tpa-items-center tpa-justify-center tpa-p-4">
